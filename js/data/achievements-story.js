// ══════════════════════════════════════════
//  ACHIEVEMENTS 追加分 ── 新ストーリー
//  「ジブラ・ジブラの正体」〜「暗号解読」〜「エピローグ」
// ══════════════════════════════════════════
ACHS.push(
  { id:'egg_mystery_person', cat:'🥚 隠し', icon:'🕵️', name:'謎の調査員',       desc:'ジブラ・ジブラの正体ファイルに触れた' },
  { id:'egg_cipher',         cat:'🥚 隠し', icon:'📡', name:'解読の糸口',         desc:'67からの暗号を受信した' },
  { id:'egg_cipher_solved',  cat:'🥚 隠し', icon:'🔓', name:'解読完了',           desc:'ミャウルの暗号を解読した' },
